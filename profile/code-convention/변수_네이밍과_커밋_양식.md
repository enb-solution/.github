...
| 항목     | 규칙                       | 예시                                                    |
| -------- | -------------------------- | ------------------------------------------------------- |
| 폴더명   | kebab-case                 | user-page                                               |
| 파일명   | kebab-case + `.타입명.ts`  | user.controller.ts, user.service.ts, create-user.dto.ts |
| 클래스명 | PascalCase (파일명과 별개) | class UserService {}                                    |
...
| ESLint          | 개인별 설정 사용                |
| Prettier        | (이주임님 내용 예정)            |
| 패키지 매니저   | pnpm (monorepo, workspace 기반) |
| 날짜 라이브러리 | date-fns                        |
